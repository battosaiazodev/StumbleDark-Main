...
class UserModel {
  ...
  const username = 'StumblePride ' + CryptoUtils.GenCaracters(5).toUpperCase();
  let ipCountry = 'PL';
  let ipRegion = 'EU';
  ...
  const user = {
    ...
    balances: [
      ...
      { name: "gems", amount: 75, secondsSince: 0, secondsPerUnit: 0, maxAmount: 0, lastGiven: now },
    ...
    try {
      const config = {
        ...
        FeatureFlags: [
          ...
          { "Flag": "WorkshopCustomThumbnails", "Enabled": true},
          { "Flag": "BattlePass", "Enabled": true},
          { "Flag": "BattlePassRotation", "Enabled": true},
          { "Flag": "BattlePasses", "Enabled": true},
          { "Flag": "BattlePassesV3", "Enabled": true},
          { "Flag": "HasBattlePass", "Enabled": true},
          { "Flag": "hasBattlePass", "Enabled": true},
          { "Flag": "addBattlePassExperience", "Enabled": true},
          { "Flag": "getBattlePass", "Enabled": true},
          { "Flag": "claimBattlePassSlot", "Enabled": true},
          { "Flag": "updatedBattlePass", "Enabled": true},
          { "Flag": "completeBattlePass", "Enabled": true},
          { "Flag": "purchaseBattlePass", "Enabled": true}
        ],
        FeatureFlag: [
          "Missions",
          "FriendsList",
...
async function sendShared(req, res) {
  try {
    ...
    data.FeatureFlags.WorkshopCustomThumbnails = true;
    data.FeatureFlags.BattlePass = true;
    data.FeatureFlags.BattlePassRotation = true;
    data.FeatureFlags.BattlePasses = true;
    data.FeatureFlags.BattlePassesV3 = true;
    data.FeatureFlags.HasBattlePass = true;
    data.FeatureFlags.addBattlePassExperience = true;
    data.FeatureFlags.getBattlePass = true;
    data.FeatureFlags.hasBattlePass = true;
    data.FeatureFlags.claimBattlePassSlot = true;
    data.FeatureFlags.updatedBattlePass = true;
    data.FeatureFlags.completeBattlePass = true;
    data.FeatureFlags.purchaseBattlePass = true;
